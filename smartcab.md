...
I haven't answered this yet but I know what I will do. I need help in figure the better way to store the data from the dictionary and automate epsilon, gamma and tune_alpha. Please refer my agent.py in main structure.
